<div class="modal fade modal-customer" id="forgotPasswordModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="">
                <div class="mfp-wrapper-content modal-wrapper-content">
                    <div class="modal-forgot-password-left modal-left-item">
                        <img src="{{asset('royal/image/about_bg.jpg')}}" height="500">
                    </div>
                    <div class="modal-forgot-password-right modal-right-item">
                        <div class="mfr-top modal-right-item-top">
                            <div class="modal-close-i" data-dismiss="modal">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke="#8E9AAB">
                            ...
                            <h5 class="mrl-top-header modal-top-header">
                                Bạn chưa có tài khoản? <span onclick="openModalRegister()">Đăng kí ngay</span>
                            </h5>
                        </div>
                        <div class="content-modal-right">
                            <div class="form-title">
                                <div class="main-title">Quên mật khẩu</div>
                            </div>
                            <form class="form-forgot-pwd modal-right-form">
                                <div class="form-group input-opt">
                                    <label for="phone-number" class="col-form-label">Số điện thoại đăng ký</label>
                                    <input type="number" class="form-control" id="fg-phone-number" placeholder="Số điện thoại đăng ký">
                                    <button type="button" class="btn-send-opt" onclick="sendOpt()">Gửi mã xác nhận</button>
                                </div>
                                <div class="fg-input-phone-feedback"></div>
                                <div class="form-group">
                                    <label for="phone-number" class="col-form-label">Mã OTP</label>
                                    <input type="number" class="form-control" id="opt-code" placeholder="Nhập mã xác nhận">
                                </div>
                                <div class="fg-input-otp-feedback"></div>
                                <div class="form-group input-password new-pwd">
                                    <label for="password" class="col-form-label">Mật khẩu mới</label>
                                    <div id="newPasswordWrapper">
                                        <input type="password" class="form-control" id="fg-newPassword" placeholder="Mật khẩu mới">
                                        <span onclick="hideShowPwd('fg-newPassword', 'newPasswordWrapper')" class="pw-show hide">
                                        ...
                                        <span onclick="hideShowPwd('fg-newPassword', 'newPasswordWrapper')" class="pw-hidden">
                                    ...
                                    <div class="fg-input-new-password-feedback"></div>
                                </div>
                                <div class="form-group input-password new-pwd-retype">
                                    <label for="password" class="col-form-label">Nhập lại mật khẩu mới</label>
                                    <div id="fg-newPwdReTypeWrapper">
                                        <input type="password" class="form-control" id="fg-newPasswordReType" placeholder="Nhập lại mật khẩu mới">
                                        <span onclick="hideShowPwd('fg-newPasswordReType', 'fg-newPwdReTypeWrapper')" class="pw-show hide">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9996 9.64136C10.6696 9.64136 9.58862 10.7234 9.58862 12.0534C9.58862 13.3824 10.6696 14.4634 11.9996 14.4634C13.3296 14.4634 14.4116 13.3824 14.4116 12.0534C14.4116 10.7234 13.3296 9.64136 11.9996 9.64136ZM11.9996 15.9634C9.84262 15.9634 8.08862 14.2094 8.08862 12.0534C8.08862 9.89636 9.84262 8.14136 11.9996 8.14136C14.1566 8.14136 15.9116 9.89636 15.9116 12.0534C15.9116 14.2094 14.1566 15.9634 11.9996 15.9634Z" fill="#666666"/>
                                                <mask id="mask0_29_638" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="2" y="4" width="20" height="17">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.00024 4.00024H22.0001V20.1052H2.00024V4.00024Z" fill="white"/>
                                        ...
                                        <span onclick="hideShowPwd('fg-newPasswordReType', 'fg-newPwdReTypeWrapper')" class="pw-hidden">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                  d="M9.76094 15.6172C9.56894 15.6172 9.37694 15.5442 9.23094 15.3972C8.49294 14.6602 8.08594 13.6802 8.08594 12.6382C8.08594 10.4782 9.84194 8.72119 11.9999 8.72119C13.0379 8.72119 14.0459 9.14019 14.7649 9.87119C15.0549 10.1672 15.0519 10.6412 14.7559 10.9312C14.4609 11.2232 13.9869 11.2182 13.6959 10.9242C13.2569 10.4772 12.6389 10.2212 11.9999 10.2212C10.6689 10.2212 9.58594 11.3052 9.58594 12.6382C9.58594 13.2792 9.83694 13.8832 10.2909 14.3372C10.5839 14.6302 10.5839 15.1042 10.2919 15.3972C10.1449 15.5442 9.95294 15.6172 9.76094 15.6172"
                                    ...
                                    <div class="fg-input-confirm-new-password-feedback"></div>
                                </div>
                                <div>
                                    <button type="button" class="btn-green btn-confirm" onclick="confirmForgetPassword()">Xác nhận</button>
                                </div>
                            </form>
                        </div>
                    </div>
