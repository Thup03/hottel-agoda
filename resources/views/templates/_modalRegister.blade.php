<div class="modal fade modal-customer" id="registerModal" tabindex="-1" role="dialog"
    aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="">
                <div class="mb-wrapper-content modal-wrapper-content">
                    <div class="modal-register-left modal-left-item">
                        <img src="{{asset('royal/image/about_bg.jpg')}}" height="600">
                    </div>
                    <div class="modal-register-right modal-right-item">
                        <div class="mlr-top modal-right-item-top">
                            ...
                            <h2 class="mrl-top-header modal-top-header">
                                <span onclick="openModalLogin()"> Đăng nhập ngay</span>
                            </h2>
                        </div>
                        <div class="content-modal-right">
                            ...
                            <input type="hidden" id="getPositionAccount" value="1">
                            <div class="register-feedback"></div>
                            <div class="tab-content" id="registerNavTabContent">
                                <form class="form-register modal-right-form" id="formRegisterContent">
                                    <!--                                    <div id="formRegisterContent">-->
                                    <div class="form-group">
                                        <label for="username" class="col-form-label">Tên người dùng <span>*</span></label>
                                        <input type="text" class="form-control" id="userName" placeholder="Nhập tên người dùng">
                                    </div>
                                    <div class="r-input-username-feedback"></div>

                                    <div class="form-group input-opt">
                                        <label for="phone-number" class="col-form-label">Số điện thoại <span>*</span></label>
                                        <input type="number" class="form-control" id="phoneNumber" placeholder="Nhập số điện thoại">
                                    </div>
                                    <div class="r-input-phone-feedback"></div>

                                    <div class="form-group input-password">
                                        <label for="password" class="col-form-label">Mật khẩu <span>*</span></label>
                                        <div id="pwdRegisterWrapper">
                                            <input type="password" class="form-control" id="passwordRegister" placeholder="Nhập mật khẩu của bạn">
                                            <span onclick="hideShowPwd('passwordRegister', 'pwdRegisterWrapper')" class="pw-show hide">
                                            ...
                                            <span onclick="hideShowPwd('passwordRegister', 'pwdRegisterWrapper')" class="pw-hidden">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <div class="r-input-password-feedback"></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="phone-number" class="col-form-label">Địa chỉ <span>*</span></label>
                                        <input type="text" class="form-control" id="address"
                                            placeholder="Nhập địa chỉ của bạn">
                                    </div>
                                    <div class="r-input-address-feedback"></div>

                                    <div>
                                        <button type="button" class="btn-green btn-register" onclick="register()">Đăng
                                            ký</button>
                                    </div>
                                    <!--                                    </div>-->
                                </form>
