	...
	<div class="row">
			...
			<div class="box">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<textarea name="description" type="text" class="form-control" id="getDescription" placeholder="Description" rows="5" cols="10"></textarea><br>
		...
		<div class="col-xs-4"> 
			<div class="box">
				...
				<div class="box-header">
					<label for="" style="margin-top: 10px;">Chủ đề</label>
				</div>
