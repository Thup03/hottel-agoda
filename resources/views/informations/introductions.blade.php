...
<div class="form-group">
	<br>
	<label for="sel1">Nội dung giới thiệu</label>
	<br>
	<br>
...
<br>
<button type="button" data-id={{$intro->id}} class="btn btn-danger btn-update">Cập nhật thông tin</button>
